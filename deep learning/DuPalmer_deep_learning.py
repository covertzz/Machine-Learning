#-------------------------------------------------------------------------
# AUTHOR: Palmer Du 
# FILENAME: DuPalmer_deep_learning
# SPECIFICATION: this program tries to classify different clothing items into their respective categories. 
#                I am using the Fashion MNIST dataset using keras to pull it. I am also using tensorflow for
#                the machine learning library. The model will iterate through different combinations of parameters
#                and will determine the most accurate model.
...
for x in n_hidden:                          #looking for the best parameters w.r.t the number of hidden layers
    for y in n_neurons:                      #looking for the best parameters w.r.t the number of neurons
        for z in l_rate:                  #looking for the best parameters w.r.t the learning rate
            ...
            for sample in range(len(class_predicted)):
                if class_predicted[sample] == y_test[sample]:
                    accuracy += 1
